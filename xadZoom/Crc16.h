/*
	...
	should be near-equal to other similar ?
...
protected:
  ...
  const uint16_t xadCRC_1021_crctable[256] = {
...
public:
	...
	uint16_t xadCRC_1021(const uint8_t * Mem, int32_t Size)
	{
		uint16_t CRC = 0;
		while(Size--)
		{
	...
	uint16_t xadCRC_1021_2(const uint8_t * Mem, int32_t Size)
	{
		uint16_t CRC = 0;
		while(Size--)
		{
