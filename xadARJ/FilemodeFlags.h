...
// used in various archivers in essentially same way
//
...
// these match msdos flags in Lha, possibly others
//
...
// these match Unix-style file-mode flags
// in various archives (Lha, ARJ) 
//
